...
interface FinSettings {
  currency: string;
  pix_fee_percent: string;
  pix_fee_fixed: string;
  card_fee_percent: string;
  card_fee_fixed: string;
...
export default function FinancialSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-display font-bold">Configurações Financeiras</h1>
        <p className="text-muted-foreground text-sm">Taxas, custos padrão e preferências</p>
      </div>

      <Card className="shadow-premium border-0 max-w-2xl">
