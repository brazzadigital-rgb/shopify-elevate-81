        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button size="sm"><Plus className="w-4 h-4 mr-1" />Lançamento</Button>
            </DialogTrigger>
              ...
              <tbody>
                {entries.map(e => (
                  <tr key={e.id} className="border-b hover:bg-muted/10">
                    ...
                    <td className="p-3">
                      <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase ${e.entry_type === "income" ? "bg-emerald-100 text-emerald-700" : "bg-red-100 text-red-700"}`}>
