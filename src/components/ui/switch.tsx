...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-full bg-foreground shadow-md ring-0 transition-all duration-300 data-[state=checked]:translate-x-[30px] data-[state=unchecked]:translate-x-[3px] data-[state=checked]:bg-[hsl(0,0%,15%)]",
      )}
    />
  </SwitchPrimitives.Root>
));
